...
Эти права – быстрый способ настроить SimpleClans. Некоторые из них добавлены автоматически (см. приписку авто). Если вы хотите настроить каждое разрешение по отдельности (см. [индивидуальные права](permissions.md#individualnye-prava)), то сперва отрицайте эти права.
...
Вам не нужно добавлять их, если права добавлены [автоматически ](permissions.md#superperms-prava-nekotorye-dobavlyayutsya-avtomaticheski)(супер-права).\
\
