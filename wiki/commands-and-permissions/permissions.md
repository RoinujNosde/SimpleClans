...
Эти разрешения – быстрый способ настроить SimpleClans. Некоторые добавлены автоматические \(см. приписку авто\). Если вы хотите настроить каждое разрешение по отдельности \(индивидуальные права\), то сначала нужно сначала отрицать эти права.
